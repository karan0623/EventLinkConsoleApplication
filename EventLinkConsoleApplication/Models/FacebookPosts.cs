...
namespace EventLinkConsoleApplication.Models
{
    ...
    public partial class FacebookPosts
    {
        public static FacebookPosts[] FromJson(string json) => JsonConvert.DeserializeObject<FacebookPosts[]>(json, Models.Converter.Settings);
    }

    public static class Serialize
    {
        public static string ToJson(this FacebookPosts[] self) => JsonConvert.SerializeObject(self, Models.Converter.Settings);
    }
